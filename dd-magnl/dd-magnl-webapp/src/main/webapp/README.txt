...
This package contains:
   ...
   Magnolia Core 5.5.1
   Magnolia Internationalization Framework 5.5.1
   Magnolia Imaging Support Module 3.3
   Magnolia JAAS 5.5.1
   Magnolia Imaging Module 3.3
   Magnolia Rendering 5.5.1
   Magnolia Templating 5.5.1
   Magnolia Templating for JSP 5.5.1
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.5.1.html
...
Copyright 2003-2017 Magnolia International Ltd.
